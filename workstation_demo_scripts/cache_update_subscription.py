...
from mstrio.distribution_services import (CacheUpdateSubscription, Content, list_subscriptions,
                                          CacheType)
...
content_prop = Content.Properties(format_type=Content.Properties.FormatType.EXCEL)
...
cache_update_sub = CacheUpdateSubscription.create(
    connection=conn, project_name=project_name,
    name=f'Validation_{content_type.value}_{content_id}_CACHE', contents=content,
    schedules=schedules_ids, delivery_expiration_date='2025-12-31', send_now=True,
