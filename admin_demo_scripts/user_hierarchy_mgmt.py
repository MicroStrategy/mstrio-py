...
print(list_user_hierarchies(conn))
...
attribute1 = HierarchyAttribute(
    object_id='8D679D3511D3E4981000E787EC6DE8A4', # sample object id
    entry_point=True,
    name='Call Center',
    element_display_option=ElementDisplayOption.ALL_ELEMENTS,
)

attribute2 = HierarchyAttribute(
    object_id="8D679D3F11D3E4981000E787EC6DE8A4",
    entry_point=True,
    name="Country",
    element_display_option="all_elements"
)
...
new_user_hierarchy = UserHierarchy.create(
    ...
    destination_folder_id='98FE182C2A10427EACE0CD30B6768258',  # sample folder id
)
