"""This is the demo script to show how to export data from Strategy with
...
# Strategy data types. By default, numeric data is modeled as MSTR metrics
...
# Limitations
# Updating SuperCubes that were not created using the Strategy REST API is
# not possible. This applies for example to Cubes created via Strategy Web
# client.
