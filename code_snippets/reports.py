...
REPORT_CACHE_ID_3 = $report_cache_id_3  # Insert ID of report cache on which you want to perform actions
REPORT_CACHE_ID_4 = $report_cache_id_4  # Insert ID of report cache on which you want to perform actions
...
list_of_caches_for_db_login = Report.list_caches(
    connection=conn, db_login_id=DB_CONNECTION_ID
)
...
report_cache_2 = ContentCache(connection=conn, id=REPORT_CACHE_ID_2)
...
report_cache_2.delete()

# Delete content cache without confirmation prompt
report_cache_2.delete(force=True)
...
ContentCache.load_caches(conn, cache_ids=[REPORT_CACHE_ID_3, REPORT_CACHE_ID_4])

# Unload multiple caches
ContentCache.unload_caches(conn, cache_ids=[REPORT_CACHE_ID_3, REPORT_CACHE_ID_4])

# Delete multiple caches with confirmation prompt
ContentCache.delete_caches(conn, cache_ids=[REPORT_CACHE_ID_3, REPORT_CACHE_ID_4])

# Delete multiple caches without confirmation prompt
ContentCache.delete_caches(conn, cache_ids=[REPORT_CACHE_ID_3, REPORT_CACHE_ID_4], force=True)
