...
class PandasDataframeEncoder:
    """Internal method for converting a Pandas DataFrame to Strategy
    compliant base64 encoded JSON.

    When creating a data set, Strategy APIs require the tabular data to
    ...
    sets, Strategy APIs require the JSON data to be formatted using
