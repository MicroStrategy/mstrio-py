...
class Prompt(CopyMixin, DeleteMixin, Entity, MoveMixin):
    ...
    Attributes:
        ...
        type (str): Type of the prompt. Possible values are:
            - UNSUPPORTED
            - VALUE
            - ELEMENTS
            - EXPRESSION
    ...
    Note:
        In answer mode, only one of key, id, or name needs to be provided along
        with answers. The key is recommended as it's always unique, unlike ID
        or name which can be shared. In API mode, either id or name must be
        provided along with a connection object.
    """
    ...
    def __init__(
        ...
        if connection is None and key is not None and answers is not None:
            ...
            raise ValueError(
                "Either provide (key + answers) without connection for answer mode or "
                "(connection + id/name) for API-based initialization"
            )
    ...
    def create_value_prompt(
        ...
        Args:
            ...
            default_answer (dict | str | int | float, optional): Default answer
                ...
                number.
            question (str, optional): Question text for the prompt.
            show_expression_as (ExpressionFormat | str, optional): How
    ...
    def alter(
        ...
        default_answer: dict | int | float | None = None,
        instruction: str | None = None,
        ...
        default_answer (dict | int | float, optional): Default answer value.
            Can be a dictionary, integer, or floating-point number.
