...
from mstrio.admin.subscription.common import RefreshPolicy
...
class Content(Dictable):
    ...
    class Properties(Dictable):
        ...
        def __init__(self,
            ...
            self.export_to_pdf_settings = export_to_pdf_settings if format_type == self.FormatType.PDF or format_type == self.FormatType.PDF.value else None
    ...
    class RefreshCondition(Dictable):
        ...
        class TableRefreshInfo(Dictable):
            ...
            class AlternateSource(Dictable):
                ...
                def __init__(self, db_role_id: str = None, namespace: str = None, table_name: str = None, url: str = None):
            ...
            # TableRefreshInfo
            def __init__(self, id: str, refresh_policy: RefreshPolicy, alternate_source: AlternateSource = None):
                self.id = id
        ...
        from_dict_map = {
            "tables": lambda tables: [TableRefreshInfo.from_dict(t) for t in tables],
            "dataset_refresh_policy": RefreshPolicy,
            "filters": lambda filters: [SubscriptionFilter.from_dict(f) for f in filters]
        }
