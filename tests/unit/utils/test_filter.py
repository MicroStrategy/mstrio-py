...
class TestFilter(unittest.TestCase):
    ...
    def test_init_attribute_elements(self):
        """Test that when not loading attribute elements, filter's attribute
        elements are None."""
    ...
    def test_select_attribute_id_list(self):
        """Test adding an object via list of ids adds the ids to filter
        property."""
    ...
    def test_select_duplicate_attribute_id(self):
        """Tests adding a duplicate id does not add the second id to the
        selected filter."""
    ...
    def test_select_attr_elem_id(self):
        """Test adding an object via id or list of ids adds the ids to filter
        property."""
    ...
    def test_select_invalid_object_id(self):
        """Tests adding an invalid object id does not add the object id to
        selected filters."""
    ...
    def test_requested_objects_one_attribute(self):
        """Test that choosing 1 att should return matching requested object in
        body."""
    ...
    def test_requested_objects_two_attribute(self):
        """Test that choosing 2 att should return matching requested object in
        body."""
    ...
    def test_requested_objects_one_metric(self):
        """Test that choosing 1 met should return matching requested object in
        body."""
    ...
    def test_requested_objects_two_metric(self):
        """Test that choosing 2 met should return matching requested object in
        body."""
    ...
    def test_requested_objects_both_list(self):
        """Test that adding lists of attributes and metrics yields requested
        objects with correct elements."""
    ...
    def test_view_filter_same_attrib_one_element(self):
        """Test that choosing 1 att elem should return matching view filter in
        body."""
    ...
    def test_view_filter_same_attrib_two_element(self):
        """Test that choosing 2 att elems from same attribute should return
        matching view filter in body."""
    ...
    def test_view_filter_multi_attrib_element(self):
        """Test that choosing att elem across attributes forms a correct view
        filter body."""
