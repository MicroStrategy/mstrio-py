...
from production.tests.resources.mocks.mock_report import MockReports
...
class TestReport(unittest.TestCase):
    test_df_path = 'production/tests/resources/api-responses/reports/iris_report_dumped.pkl'
    report_info_path = 'production/tests/resources/api-responses/reports/report_info.json'
    report_definition_path = 'production/tests/resources/api-responses/reports/report_definition.json'
    ...
    def test_apply_filters(self):
        tested_report = report.Report(parallel=False, connection=self.connection, report_id=self.report_id, progress_bar=False)
    ...
    def test_to_dataframe_no_filter(self):
        tested_report = report.Report(parallel=True, connection=self.connection, report_id=self.report_id, progress_bar=False)
