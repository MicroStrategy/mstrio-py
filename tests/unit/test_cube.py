...
import pandas as pd
from production.tests.resources.mocks.mock_cube import MockCubes
...
class TestCube(unittest.TestCase):
    test_df_path = 'production/tests/resources/api-responses/cubes/iris_cube_dumped.pkl'
    test_multi_df_path = 'production/tests/resources/api-responses/cubes/iris_cube_multi_dumped.pkl'
    cube_info_path = 'production/tests/resources/api-responses/cubes/cube_info.json'
    cube_definition_path = 'production/tests/resources/api-responses/cubes/cube_definition.json'
    ...
    def test_apply_filters(self):
        tested_cube = cube.Cube(parallel=False, connection=self.connection, cube_id=self.cube_id, progress_bar=False)
    ...
    def test_attribute_form_filters(self):
        ...
        self.assertEqual(tested_cube.selected_attributes, [
                         ["7BC6BEBA11EA4C2060710080EFD5AA25", "45C11FA478E745FEA08D781CEA190FE5"]])
        tested_cube.clear_filters()
        tested_cube.apply_filters(attributes=["7BC6BEBA11EA4C2060710080EFD5AA25;45C11FA478E745FEA08D781CEA190FE5"], metrics=[
                                  "7C047DCC11EA4C205F200080EFF5EA25"])
        self.assertEqual(tested_cube.selected_attributes, [
                         ["7BC6BEBA11EA4C2060710080EFD5AA25", "45C11FA478E745FEA08D781CEA190FE5"]])
    ...
    def test_to_dataframe_no_filter(self):
        tested_cube = cube.Cube(parallel=True, connection=self.connection, cube_id=self.cube_id, progress_bar=False)
    ...
    def test_to_dataframe_attribute_element_filter(self):
        ...
        self.assertTrue(tested_cube.to_dataframe(limit=70).equals(
            self.required_df[self.required_df['Id'] == attr_el_value]))
        tested_cube = cube.Cube(parallel=False, connection=self.connection, cube_id=self.cube_id, progress_bar=False)
        attr_element_id = tested_cube.attr_elements[0]['elements'][0]['id']
        attr_el_value = tested_cube.attr_elements[0]['elements'][0]['formValues'][0]
        tested_cube.apply_filters(attr_elements=attr_element_id)
